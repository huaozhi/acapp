...
class AcGamePlayground{
    ...
    get_random_color(){
        let colors = ["bule", "pink", "green", "grey", "red", "Chocolate", "Darkorange"];
...
class Settings {
    constructor(root) {
        ...
        <div class="ac-game-settings-register">
            ...
            <br>
            <div class="ac-game-settings-acwing">
                <img width="30" src="https://app242.acapp.acwing.com.cn/static/image/settings/acwing_logo.png">
                <br>
                <div>
                    AcWing一键登录
                </div>
...
`);
    ...
    acwing_login() {
        $.ajax({
            url: "https://app242.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
    ...
    login_on_remote() { // 在远程服务器登录
        ...
        $.ajax({
            url: "https://app242.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    register_on_remote() { // 在远程服务器注册
        ...
        $.ajax({
            url: "https://app242.acapp.acwing.com.cn/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    logout_on_remote() { // 在远程服务器登出
        if (this.platform === "ACAPP")
            return false;
        $.ajax({
            url: "https://app242.acapp.acwing.com.cn/settings/logout/",
            type: "GET",
            success: function(resp) {
                console.log(resp);
                if (resp.result === "success") {
    ...
    getinfo_web() {
        let outer = this;
        $.ajax({
            url: "https://app242.acapp.acwing.com.cn/settings/getinfo/",
            type: "GET",
            data: {
    ...
    getinfo_acapp() {
        let outer = this;
        $.ajax({
            url: "https://app242.acapp.acwing.com.cn/settings/acwing/acapp/apply_code/",
            type: "GET",
            success: function(resp) {
                if (resp.result === "success") {
...
export class AcGame{
    constructor(id, AcWingOS){
        ...
        console.log('ACWingOS is',this.AcWingOS);
